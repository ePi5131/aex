...
using aex::detail::flag::operator!;
using aex::detail::flag::operator+;
using aex::detail::flag::operator~;
using aex::detail::flag::operator&;
using aex::detail::flag::operator|;
...
using aex::detail::flag::operator|=;
using aex::detail::flag::operator^=;
using aex::detail::flag::has_flag;
using aex::detail::flag::has_flag_and;
using aex::detail::flag::has_flag_or;
using aex::detail::flag::masked_eq;
